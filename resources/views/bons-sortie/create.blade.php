...
<div class="container">
    <form action="/bon-sortie" method="post">
        @csrf
        <div class="row">
            <div class="d-flex justify-content-center col-md-10 offset-1 pb-3">
                <h1>Ajouter un bon de sortie</h1>
            </div>
            <div class="col-md-10 offset-1">
                    ...
                    <div class="card-body p-3">
                        <table class="table">
                            ...
                            @foreach($equipementStocks as $eq)
                                ...
                                @if($eq->pieces()->where('quantite', '!=', '0')->get()->count() != 0)
                                    ...
                                    @foreach($eq->pieces()->where('quantite', '!=', '0')->get() as $piece)
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body p-3">
                        <div class="form-group row">
                            <label for="date_sortie" class="col-form-label col-md-3">Date de sortie</label>

                            <input id="date_sortie" type="datetime-local" class="form-control col-md-8 @error('date_sortie') is-invalid @enderror" name="date_sortie" autocomplete="date_sortie" required>

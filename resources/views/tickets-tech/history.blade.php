	...
	<div class="row">
		<div class="col-md-10 offset-1">
			<div class="pb-5">
				...
				<span class="h4">Ticket technique {{ $ticket->title }}</span>
			</div>
		</div>
		<div class="col-md-10 offset-1">
			...
			<div class="d-flex justify-content-center pt-3">
				@can('view', $ticket)
					<button class="btn btn-danger text-light mr-2" onclick="window.location.href='/ticket-tech/{{ $ticket->id }}'">Vers détails sur ce ticket</button>
				@endcan

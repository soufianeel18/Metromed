	...
	<div class="row">
		<div class="col-md-10 offset-1">
			<div class="pb-5">
				...
				<span class="h4">Bon d'entrée</span>
			</div>
		</div>
		<div class="col-md-10 offset-1">
			...
			<div class="d-flex justify-content-center pt-3">
				@can('view', $bon)
					<button class="btn btn-danger text-light mr-2" onclick="window.location.href='/bon-entree/{{ $bon->id }}'">Vers détails sur ce bon</button>
				@endcan

            ...
            <div class="col-8 offset-2">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <input id="admin" type="radio" class="@error('admin') is-invalid @enderror" name="role" value="admin" autocomplete="admin" @if($user->role == 'admin') checked @endif required>
                        </td>
                    </tr>
                    <tr>
                        @error('admin')
                    ...
                    @if($user->role == 'technicien' || $user->role == 'chef technicien' || $user->role == 'guest')
                        <tr>
                            <td>
                    ...
                    @endif
                    @if($user->role == 'commercial' || $user->role == 'chef commercial' || $user->role == 'guest')
                        <tr>
                            <td>
                    ...
                    @endif
                    @if($user->role == 'agent stock' || $user->role == 'chef stock' || $user->role == 'guest')
                        <tr>
                            <td>
